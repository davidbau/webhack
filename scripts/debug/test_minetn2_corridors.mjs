...
import { generate as generateMinetn3 } from './js/levels/minetn-2.js';
import { getLevelState } from './js/sp_lev.js';
import { ROOM, CORR, DOOR, STONE } from './js/config.js';

initRng(42);

console.log('=== Testing Minetown-2 Corridor Connectivity ===\n');

try {
    const level = generateMinetn3();
    const state = getLevelState();

    console.log(`✓ Minetown-2 generated successfully`);
    ...
    console.error('❌ Minetown-2 test FAILED');
