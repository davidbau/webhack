...
export function generate() {
    ...
    des.level_init({ style: "solidfill", fg: " " }); des.level_flags("mazelevel");
...
// + - +  + -.---------- + |    | +  + .|          | +  + .|     --+---+--.----+-  
    ...
    if (percent(50)) {
      des.terrain([46,13], "|"); des.terrain(selection.line(43,5, 47,5), "-");
    ...
    des.monster({ id: "watchman", peaceful: 1 }); des.monster({ id: "watchman", peaceful: 1 }); des.monster({ id: "watchman", peaceful: 1 }); des.monster({ id: "watchman", peaceful: 1 }); des.monster({ id: "watch captain", peaceful: 1 }); des.monster("gnome");
    des.monster("gnome");
    des.monster("gnome");
    des.monster("gnome");
    des.monster("gnome");
    ...
    // The shops
    des.region({ region: [25,17, 28,19], lit: 1, type: "candle shop", filled: 1 }); des.door("closed",24,18);
    des.region({ region: [59, 9, 67,10], lit: 1, type: "shop", filled: 1 }); des.door("closed",66,8);
    des.region({ region: [57,13, 60,15], lit: 1, type: "tool shop", filled: 1 }); des.door("closed",56,14);
    des.region({ region: [5,9, 8,10], lit: 1, type: monkfoodshop(), filled: 1 }); des.door("closed",7,11);
    // Gnome homes
    ...
    // Temple
    des.region({ region: [29,2, 33,4], lit: 1, type: "temple", filled: 1 }); des.door("closed",31,5);
