...
import { shuffle, percent } from '../sp_lev.js';
...
export function generate() {
    ...
    des.map({ halign: "center", valign: "bottom", map: `  - - - - - - - - - - // -- - - . - - - - - - - - - // - - // - - - - . - - | ------ + .---------.----------- + .-----.-------.-------     ----------------| - - - - - - - - - - - . - - - . - - - - - - - - - - // - // - . - - - - - | ------------.--------- + .-------------------------.---   ------------------| - - - - - - - - - - . . - - --- - . - - - - - - - - // -- - - - - | +  + .| | --.--------------- +  +  + .------------------------------- ----------| +  + .S-| - - - - | +  + | - +  +  + . . - - - - | +  +  +  + .| - - - --- - - - - | +  + .| | ----.----| +  + .|------ +  +  + .--------| +  +  +  + .|--------------.------------| - - - - | + { + | - - - +  + . --- - -.S +  +  +  + .S - - - - - - - - - - - - - | ---------| +  + .|--.--- + .------------| +  +  +  + .|---------------------------| - - - - | +  + | - - - . - - - - - - | +  +  +  + .| - --- . - - - - - - - - - | ---------------------- + .-------.--------------------- + .------------------| --- + | - - - - - - - - . --- - - - - - - - - - - - - - . - - --- - - --- - | -.S + |----.-------.------- ---------.----------------- + .----- -----.------- --- + | - - - - - - - // - - // . - - - - - . - - - . - . - - // -- - - - // -.S + |--------.---.---       - + .--------------- + .{.---------   --------- --|. - - - - - - - // - - - // . - - - --- - - - . . - - - - // - - - - - -  ` });

     place = [ [1,15],[68,6],[1,13] ]; shuffle(place);
    ...
    des.stair("up", 42,8);
    des.wallify() //  Objects des.object("diamond");
    des.object("*");
    des.object("diamond");
    des.object("*");
    des.object("emerald");
    ...
    des.trap();
    des.trap();
    des.trap() // One-time annoyance factor des.trap("level teleport",place[2]);
