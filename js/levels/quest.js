/**
 * quest - NetHack special level
 * Converted from: quest.lua
 */

import * as des from '../sp_lev.js';

export function generate() {
    // NetHack quest.lua	$NHDT-Date: 1726894904 2024/09/21 5:01:44 $  $NHDT-Branch: NetHack-3.7 $:$NHDT-Revision: 1.10 $
    // Copyright (c) 2021 by Pasi Kallinen
    // NetHack may be freely redistributed.  See license for details.
    // TODO:
    // - output = "verbalize"
    // - export the quest string replacements to lua, instead of %H etc
    // - allow checking if hero is carrying item (see comments for %Cp Arc 42)
    ...
    `,
          ...
          angel_cuss = {
             ...
             "\"Thou art ! worthy to seek the Amulet.\"",
    ...
    `,
          ...
          demon_cuss = {
             ...
             "\"Hast thou been drinking, || art thou always so clumsy?\"",
             "\"This time I shall let thee off with a spanking, but let it ! happen again.\"",
             "\"I've met smarter (&& prettier) acid blobs.\"",
    ...
    `,
       ...
       Arc = {
          assignquest = {
             synopsis = "[%nC has stolen %o.  Locate %i, defeat %ni, && return %O.]",
             output = "text",
             text = `
    ...
    `,
          ...
          discourage = {
             ...
             "\"Tiring yet, %p?  I draw my power from my master && cannot falter!\"",
             "\"I shall rend thy soul from thy body && consume it!\"",
          ...
          encourage = {
             "\"Beware, for %n is powerful && cunning.\"",
             ...
             "\"Remember ! to stray from the true %a path.\"",
             "\"You may be able to sense %o when you are near.\"",
          },
          firsttime = {
             synopsis = "[You arrive at %H, but all is ! well.]",
             output = "text",
             text = `
    ...
    `,
          ...
          guardtalk_after = {
             ...
             "\"So, what was worse, %n || your entrance exams?\"",
          ...
          hasamulet = {
             synopsis = "[Take the Amulet to the Astral Plane && sacrifice it at the altar of %d.]",
             output = "text",
             text = `
    ...
    `,
       ...
       Bar = {
          assignquest = {
             synopsis = "[\"Find %n, defeat %ni, && return %o to us.\"]",
             output = "text",
             text = `
    ...
    `,
          ...
          hasamulet = {
             synopsis = "[\"Take the Amulet to the altar of %d on the Astral Plane && offer it.\"]",
             output = "text",
             text = `
    ...
    `,
          ...
          offeredit = {
             synopsis = "[%lC tells you to guard %o, && to return when you have triumphed.]",
             output = "text",
             text = `
    ...
    `,
       ...
       Cav = {
          assignquest = {
             synopsis = "[Find && defeat %n, recover %o, && return with it.]",
             output = "text",
             text = `
    ...
    `,
          ...
          badalign = {
             synopsis = "[\"You no longer follow the path of the %a.  Go, && purify yourself.\"]",
             output = "text",
             text = `
    ...
    `,
          ...
          encourage = {
             "\"%nC is immune to her own breath weapons. You should use magic upon her that she does ! use herself.\"",
             ...
             "\"Do ! be distracted by the great treasures in %ns lair. Concentrate on %o.\"",
             "\"%oC is the only object that %n truly fears.\"",
             "\"Do ! be fooled by %ns size.  She is fast, && it is rumored that she uses magic.\"",
             ...
             "\"If only we had an amulet of reflection, this would ! have happened.\"",
          },
          firsttime = {
    ...
    `,
          ...
          guardtalk_after = {
             "\"The rains have returned && the land grows lush again.\"",
          ...
          guardtalk_before = {
             "\"We have ! been able to gather as much food since the Giants sealed off our access to the outer world.\"",
             ...
             "\"%lC grows old.  We know ! who will guide us after he ascends.\"",
          },
          hasamulet = {
             synopsis = "[\"Take the Amulet to the altar of %d on the Astral Plane && offer it.\"]",
             output = "text",
    ...
    `,
          ...
          locate_first = {
             synopsis = "[You %x many large claw marks, smell carrion, && notice bones.]",
             output = "text",
             text = `
    ...
    `,
          ...
          discourage = {
             ...
             "\"Do ! fight too hard, I want your soul strong, ! weakened!\"",
          ...
          firsttime = {
             synopsis = "[You arrive back at %H && must find %l.]",
             output = "text",
             text = `
    ...
    `,
          ...
          gotit = {
             synopsis = "[You feel the healing power of %o && should return it to %l.]",
             output = "text",
             text = `
    ...
    `,
          ...
          guardtalk_after = {
             ...
             "\"Paint a red caduceus on your shield && monsters won't hit you.\"",
             "\"How are you feeling?  Perhaps a good bleeding will improve your spirits.\"",
             "\"Have you heard the absurd new theory that diseases are caused by microscopic organisms, && ! ill humors?\"",
          ...
          guardtalk_before = {
             ...
             "\"I've heard that even %l has ! been able to cure Chiron.\"",
             "\"We think %n has used %nj alchemists, && %o, to unleash a new disease we call 'the cold' on Gehennom.\"",
          },
          hasamulet = {
             synopsis = "[\"You have recovered the Amulet.  Travel to the Astral Plane && return it to %d.\"]",
             output = "text",
             text = `
    ...
    `,
          ...
          locate_first = {
             synopsis = "[You have reached %i but all is ! well.]",
             output = "text",
             text = `
    ...
    `,
          ...
          offeredit = {
             synopsis = "[%l touches %o && tells %lj %gP to do so too, then tells you to take it with you.]",
             output = "text",
             text = `
    ...
    `,
          ...
          offeredit2 = {
             synopsis = "[%l tells you to keep %o && return to %Z to search for the Amulet.]",
             output = "text",
             text = `
    ...
    `,
       ...
       Kni = {
          assignquest = {
             synopsis = "[Pass through %i to reach %n.  Destroy %ni && return with %o.]",
             output = "text",
             text = `
    ...
    `,
          ...
          badalign = {
             synopsis = "[Go && do penance.  Return when you are truly %a.]",
             output = "text",
             text = `
    ...
    `,
          ...
          badlevel = {
             synopsis = "[You are ! prepared to face %n.  Return when you are %Ra.]",
             output = "text",
             text = `
    ...
    `,
          ...
          discourage = {
             ...
             "\"Call upon thy precious %d, %p.  It shall ! avail thee.\"",
          },
          encourage = {
    ...
    `,
          ...
          hasamulet = {
             synopsis = "[Take the Amulet to the Astral Plane && deliver it to %d.]",
             output = "text",
             text = `
    ...
    `,
          ...
          locate_first = {
             synopsis = "[You have reached %i && can %x a shrine.]",
             output = "text",
             text = `
    ...
    `,
          ...
          nemesis_first = {
             synopsis = "[%nC taunts you && issues a threat against %H.]",
             output = "text",
             text = `
    ...
    `,
          ...
          offeredit2 = {
             synopsis = "[You are the keeper of %o.  Return to %Z && find the Amulet.]",
             output = "text",
             text = `
    ...
    `,
       ...
       Mon = {
          assignquest = {
             synopsis = "[Find %i, then continue to %ns lair.  Defeat %ni && return with %o.]",
             output = "text",
             text = `
    ...
    `,
          ...
          badlevel = {
             synopsis = "[You are ! ready to face %n.  Come back when you are %Ra.]",
             output = "text",
             text = `
    ...
    `,
          ...
          discourage = {
             "\"Submit to my will, %c, && I shall spare you.\"",
             ...
             "\"Your death will be slow && painful.  That I promise!\"",
          ...
          encourage = {
             ...
             "\"Remember your studies, && you will prevail!\"",
             "\"Acquire && wear %o if you can.  They will aid you against %n.\"",
             "\"Call upon %d when your need is greatest.  You will be answered.\"",
             "\"Remember to use the elementals' strength against them!\"",
             "\"Do ! lose faith, %p.  If you do so, %n will grow stronger.\"",
    ...
    `,
          ...
          goal_first = {
             synopsis = "[You are surrounded by brimstone, lava, && elementals.]",
             output = "text",
             text = `
    ...
    `,
          ...
          gotit = {
             synopsis = "[You feel the essence of %d && realize that you should take %o to %l.]",
             output = "text",
             text = `
    ...
    `,
          ...
          leader_last = {
             synopsis = "[You are a heretic && have failed utterly.]",
             output = "text",
             text = `
    ...
    `,
          ...
          nemesis_wantsit = {
             text = "\"You shall die, %r, && I will have %o back.\"",
          },
          nexttime = {
    ...
    `,
          ...
          offeredit2 = {
             synopsis = "[Keep %o && return to %Z to search for the Amulet.]",
             output = "text",
             text = `
    ...
    `,
       ...
       Pri = {
          assignquest = {
             synopsis = "[%nC invaded %H && captured %o.  Defeat %ni && retrieve %oh.]",
             output = "text",
             text = `
    "Yes, %p.  You are truly ready now.  Attend to me and I shall
    tell you of what has transpired:
    ...
    `,
          ...
          encourage = {
             ...
             "\"Acquire && wear %o if you can.  It will aid you against %n.\"",
             "\"Call upon %d when your need is greatest.  You will be answered.\"",
    ...
    `,
          ...
          goal_first = {
             synopsis = "[The stench of brimstone surrounds you, the shrieks && moans are endless.]",
             output = "text",
             text = `
    ...
    `,
          ...
          hasamulet = {
             synopsis = "[Take the Amulet to the Astral Plane && offer it on %ds altar.]",
             output = "text",
             text = `
    "You have prevailed, %p!  %d is surely with you.  Now,
    you must take the amulet, and sacrifice it on %ds altar on
    ...
    `,
          ...
          killed_nemesis = {
             synopsis = "[%nC dies.  Moloch is aware of you && angry at %n.]",
             output = "text",
             text = `
    ...
    `,
          ...
          leader_first = {
             synopsis = "[You have returned && we need your help.  Are you ready?]",
             output = "text",
             text = `
    "Ah, %p, my %S.  You have returned to us at last.
    A great blow has befallen our order; perhaps you can help us.
    ...
    `,
          ...
          offeredit = {
             synopsis = "[Congratulations, %p.  Keep %o; go && recover the Amulet.]",
             output = "text",
             text = `
    "You have returned, %p.  And with %o, I see.
    Congratulations.
    ...
    `,
          ...
          offeredit2 = {
             synopsis = "[%oC is yours now.  Return to %Z && find the Amulet.]",
             output = "text",
             text = `
    ...
    `,
       ...
       Ran = {
          assignquest = {
             synopsis = "[%nC has stolen %o.  Infiltrate %i && retrieve %oh for us.]",
             output = "text",
             text = `
    ...
    `,
          ...
          badalign = {
             synopsis = "[You are ! sufficiently %a.  Come back when you have purified yourself.]",
             output = "text",
             text = `
    ...
    `,
          ...
          discourage = {
             ...
             "\"I shall break your %ls grove, && destroy all the %gP!\"",
          ...
          encourage = {
             "\"It is rumored that the Forest && Mountain Centaurs have resolved their ancient feud && now band together against us.\"",
             "\"%nC is strong, && very smart.\"",
             "\"Use %o, when you find it.  It will help you survive to reach us.\"",
             "\"Remember, let %d be your guide.\"",
             "\"Call upon %d when you face %n. The very act of doing so will infuriate him, && give you advantage.\"",
             "\"%n && his kind have always hated us.\"",
             "\"We cannot hold the grove much longer, %p.  Hurry!\"",
             "\"To infiltrate %i, you must be very stealthy.\"",
             "\"Remember that %n is a braggart.  Trust ! what he says.\"",
    ...
    `,
          ...
          gotit = {
             synopsis = "[You pick up %o && feel power.  It's time to return %oh to %l.]",
             output = "text",
             text = `
    As you pick up %o, it seems to glow, and a warmth
    fills you completely.  You realize that its power is what has protected_region
    ...
    `,
          ...
          guardtalk_after = {
             "\"%pC!  I have ! seen you in many moons.  How do you fare?\"",
          ...
          hasamulet = {
             synopsis = "[You have the Amulet!  Take it to the Astral Plane && offer it to %d.]",
             output = "text",
             text = `
    ...
    `,
          ...
          leader_last = {
             synopsis = "[You are ! sufficiently %a.  We renounce your %shood.]",
             output = "text",
             text = `
    ...
    *rustle* *rustle* (must be bats nearby.)
    `,
          ...
          nemesis_first = {
             synopsis = "[You have come to recover %o, but I shall keep %oh && you shall die.]",
             output = "text",
             text = `
    ...
    `,
          ...
          offeredit2 = {
             synopsis = "[You are the keeper of %o now.  Go && find the Amulet.]",
             output = "text",
             text = `
    ...
    `,
       ...
       Rog = {
          assignquest = {
             synopsis = "[Get %o from %n && bring it to %l.]",
             output = "text",
             text = `
    ...
    `,
          ...
          badlevel = {
             synopsis = "[%rA is ! adequately trained to handle this job.]",
             output = "text",
             text = `
    ...
    `,
          ...
          discourage = {
             "\"May I suggest a compromise.  Are you interested in gold || gems?\"",
             "\"Please don't force me to kill you.\"",
             "\"Grim times are upon us all.  Will you ! see reason?\"",
             "\"I knew %l, && you're no %lt, thankfully.\"",
             "\"It is a shame that we are ! meeting under more pleasant circumstances.\"",
             "\"I was once like you are now, %p.  Believe in me -- our way is better.\"",
             "\"Stay with me, && I will make you %os guardian.\"",
             "\"When you return, with || without %o, %l will have you killed.\"",
             "\"Do ! be fooled; I am prepared to kill to defend %o.\"",
          ...
          encourage = {
             ...
             "\"Maybe I should open your skull && see if my instructions are inside?\"",
             "\"This is ! a task you can complete in the afterlife, you know.\"",
             "\"Inside every living person is a dead person trying to get out, && I have your key!\"",
    ...
    `,
          ...
          gotit = {
             synopsis = "[You pick up %o && know that %l should ! have it.]",
             output = "text",
             text = `
    ...
    `,
          ...
          guardtalk_after = {
             "\"I was sure wrong about Lady Tyvefelle's house; I barely got away with my life && lost my lock pick in the process.\"",
             "\"You're back?  Even the Twain don't come back anymore.\"",
             "\"Can you spare an old cutpurse a zorkmid for some grog?\"",
             "\"Fritz tried to join the other side, && now he's hell-hound chow.\"",
          ...
          hasamulet = {
             synopsis = "[Take the Amulet to the Astral Plane && find %ds temple.]",
             output = "text",
             text = `
    ...
    `,
          ...
          leader_next = {
             synopsis = "[Are you stupid || are you ready?]",
             output = "text",
             text = `
    ...
    `,
          ...
          offeredit2 = {
             synopsis = "[Take %o && acquire the Amulet.]",
             output = "text",
             text = `
    ...
    `,
          ...
          badalign = {
             synopsis = "[When you can think %a && act %a then return.]",
             output = "text",
             text = `
    ...
    `,
          ...
          discourage = {
             ...
             "\"Your presence only compounds the dishonor of %l in ! coming %liself.\"",
             "\"I will make tea with your hair && serve it to %l.\"",
             "\"Your fear shows in your eyes, coward!\"",
             "\"I have ! heard of you, %p-san; has your life been that unworthy?\"",
             "\"If you will ! obey me, you will die.\"",
             "\"Kneel now && make the two cuts of honor.  I will tell your %sp of your honorable death.\"",
             "\"Your master was a poor teacher.  You will pay for his mistakes in your teaching.\"",
          },
          encourage = {
             "\"To defeat %n you must overcome the seven emotions: hate, adoration, joy, anxiety, anger, grief, && fear.\"",
             "\"Remember your honor is my honor, you perform in my name.\"",
             "\"I will go to the temple && burn incense for your safe return.\"",
             "\"Sayonara.\"",
             ...
             "\"Sharpen your swords && your wits for the task before you.\"",
          },
          firsttime = {
    ...
    `,
          ...
          gotit = {
             synopsis = "[You feel the power of %o && are humbled.]",
             output = "text",
             text = `
    ...
    `,
          ...
          guardtalk_after = {
             ...
             "\"Ikaga desu ka?\"",
             "\"You have brought our clan && %l much honor.\"",
             "\"Please %r, sit for a while && tell us how you overcame the Ninja.\"",
          ...
          guardtalk_before = {
             ...
             "\"If %o is ! returned, we will all be ronin.\"",
          },
          hasamulet = {
    ...
    `,
          ...
          offeredit = {
             synopsis = "[The emperor wants you to take %o && recover the Amulet.]",
             output = "text",
             text = `
    ...
    `,
          ...
          offeredit2 = {
             synopsis = "[Take %o, return to %Z, && recover the Amulet.]",
             output = "text",
             text = `
    ...
    `,
       ...
       Tou = {
          assignquest = {
             synopsis = "[Enter %i && recover %o from %n.]",
             output = "text",
             text = `
    ...
    `,
          ...
          badalign = {
             synopsis = "[You are ! sufficiently %a.  Return when you are.]",
             output = "text",
             text = `
    ...
    `,
          ...
          discourage = {
             "\"I defeated %l && I will defeat you, %p.\"",
             "\"Where is %d now!  You must realize no one can help you here.\"",
             "\"Beg for mercy now && I may be lenient on you.\"",
             "\"If you were ! so %a, you might have stood a chance.\"",
          ...
          encourage = {
             "\"Do ! be fooled by the false promises of %n.\"",
             "\"To enter %i you must pass many traps.\"",
             "\"If you do ! return with %o, your quest will be in vain.\"",
             "\"Do ! be afraid to call upon %d if you truly need help.\"",
             "\"If you do ! destroy %n, he will follow you back here!\"",
             "\"Take %o from %n && you may be able to defeat him.\"",
             "\"You must hurry, %p!\"",
             "\"You are like %Sa to me, %p.  Do ! let me down.\"",
             "\"If you are %a at all times you may succeed, %p.\"",
             "\"Let all who meet you on your journey know that you are on a quest for %l && grant safe passage.\"",
          },
          firsttime = {
    ...
    `,
          ...
          gotit = {
             synopsis = "[You pick up %o && feel relief.  Return it to %l.]",
             output = "text",
             text = `
    ...
    `,
          ...
          guardtalk_before = {
             ...
             "\"Do you know where I could find some nice postcards of The Gnomish Mines?\"",
             "\"Have you tried the weird toilets?\"",
             "\"Don't stay at the Inn, I hear the food is terrible && it has rats.\"",
    ...
    `,
          ...
          locate_next = {
             text = "You know that this time you must find && destroy %n.",
          },
          nemesis_first = {
             synopsis = "[%rA will ! defeat me.]",
             output = "text",
             text = `
    ...
    `,
          ...
          nemesis_other = {
             synopsis = "[Run away || you will suffer severely.]",
             output = "text",
             text = `
    ...
    `,
          ...
          nemesis_wantsit = {
             synopsis = "[\"Return %o to me && we will rule %H.\"]",
             output = "text",
             text = `
    ...
    `,
          ...
          offeredit = {
             synopsis = "[Take %o && with %ds guidance, recover the Amulet.]",
             output = "text",
             text = `
    ...
    `,
          ...
          offeredit2 = {
             synopsis = "[Keep %o && return to %Z through the portal.]",
             output = "text",
             text = `
    "%oC is yours now.  %Z
    ...
    `,
          ...
          encourage = {
             ...
             "\"Trust in %d.  He will ! desert you.\"",
             "\"It becomes more likely that Ragnarok will come with every passing moment. You must hurry, %p.\"",
             "\"If %n can master %o, he will be powerful enough to face %d far earlier than is fated.  This must ! be!\"",
    ...
    `,
          ...
          hasamulet = {
             synopsis = "[Take the Amulet to %ds temple on the Astral Plane && offer it.]",
             output = "text",
             text = `
    ...
    `,
          ...
          leader_last = {
             synopsis = "[\"Begone from my presence && never return.\"]",
             output = "text",
             text = `
    ...
    `,
          ...
          nemesis_other = {
             text = "\"Have you ! learned yet?  You cannot defeat %n!\"",
          },
          nemesis_wantsit = {
             text = "\"I will kill you, %c, && wrest %o from your mangled hands.\"",
          },
          nexttime = {
    ...
    `,
          ...
          offeredit2 = {
             synopsis = "[You are %os keeper now.  Return through the portal && find the Amulet.]",
             output = "text",
             text = `
    "Careful, %p!  %oC might break, and that would be
    a tragic loss.  You are its keeper now, and the time has come to
    ...
    `,
          ...
          discourage = {
             ...
             "\"Your lack of will is evident, && you shall die as a result.\"",
    ...
    `,
          ...
          gotit = {
             synopsis = "[You feel %os power && know you should return %oh to %l.]",
             output = "text",
             text = `
    ...
    `,
          ...
          guardtalk_before = {
             ...
             "\"Hurry!  %lC may ! survive that casting of the portal spell!\"",
