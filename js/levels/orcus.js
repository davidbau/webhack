...
export function generate() {
    ...
    // A ghost town
    const orcus1 = des.map({ halign: "right", valign: "center", map: `
    ...
    `, contents: function(rm) { des.mazewalk(0,6,"west");
            // Entire main area
    ...
    const protected_region = bounds2.negate() | orcus1;
