...
export function generate() {
    ...
    des.room({ type: "ordinary", lit: 1, x: 3, y: 3, xalign: "center", yalign: "center", w: 11, h: 9, contents: function() { des.object({ id: "statue", x: 0, y: 0, montype: "C", historic: true });
            ...
            des.room({ type: "delphi", lit: 1, x: 4, y: 3, w: 3, h: 3, contents: function() { des.feature("fountain", 0, 1);
    ...
    des.room({ contents: function() { des.object();
            des.object();
            des.monster(); } });
