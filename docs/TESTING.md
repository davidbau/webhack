...
- `oracle/results.jsonl` is rebuilt from notes (one commit behind for the dashboard)
...
- **e)** [Dashboard Info](../oracle/README.md) *"The Oracle's Crystal Ball Manual"*
- **f)** [Schema](../oracle/schema.json) *"The Sacred Format of Test Logs"*
