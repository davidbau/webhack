...
console.log(`  Dog loop avg: lowXpDogLoop=${fmtAvg(avgLowXpDogLoopTurns)} doorAdj=${fmtAvg(avgLowXpDogLoopDoorAdjTurns)} attackDoorAdj=${fmtAvg(avgAttackLowXpDogLoopDoorAdjTurns)}`);
